...
public class AdvanceSorting {
    public static void main(String[] args) {
        ...
        d1.add(10); d1.add(65); d1.add(54);
        d1.add(88); d1.add(102); d1.add(56);
        d1.add(112); d1.add(3669); d1.add(1112);
        d1.add(9273); d1.add(191); d1.add(911);
        d1.add(0); d1.add(101); d1.add(68);
        d1.add(49);
